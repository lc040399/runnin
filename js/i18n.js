...
(() => {
  ...
  const EN = new Map(Object.entries({
    ...
    "på kortet": "on the map", "på ruten": "on course", "i mål": "finished", "illustrativ rute": "illustrative route", "officiel rute": "official route", "Førende lige nu": "Leading right now", "Højdeprofil": "Elevation profile", "Målstregen": "The finish line", "Ingen i mål endnu - følg med her.": "No finishers yet - follow along here.", "i dag": "today", "Se dagens løb →": "See today's races →", "Se løbet i dag": "See the race today", "Afholdes i dag": "Happening today", "løb i dag": "races today",
    // detalje
